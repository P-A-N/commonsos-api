...
public class CreateAdMessageThreadIfNotExistsTest extends IntegrationTest {
  ...
  public void setup() throws Exception {
    ...
    ad =  create(new Ad().setPublishStatus(PUBLIC).setCreatedUserId(adCreator.getId()).setCommunityId(community.getId()).setPoints(BigDecimal.TEN).setTitle("title"));
