...
public class SearchCommunityNotificationTest extends IntegrationTest {
  ...
  public void setup() throws Exception {
    community1 =  create(new Community().setName("community1").setPublishStatus(PUBLIC));
    community2 =  create(new Community().setName("community2").setPublishStatus(PUBLIC));
  ...
  public void communityNotificationList_pagenation() throws Exception {
    // prepare
    Community community =  create(new Community().setName("page_community").setPublishStatus(PUBLIC));
