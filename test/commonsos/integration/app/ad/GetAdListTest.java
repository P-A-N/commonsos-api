...
public class GetAdListTest extends IntegrationTest {
  ...
  public void setupData() throws Exception {
    ...
    ad = create(new Ad().setCreatedUserId(fooUser.getId()).setCommunityId(community.getId()).setPoints(TEN));
    /*ad2 = */create(new Ad().setCreatedUserId(barUser.getId()).setCommunityId(community.getId()).setPoints(TEN));
    fooAd = create(new Ad().setCreatedUserId(barUser.getId()).setCommunityId(community.getId()).setPoints(TEN).setTitle("foo"));
    fooAd2 = create(new Ad().setCreatedUserId(barUser.getId()).setCommunityId(community.getId()).setPoints(TEN).setDescription("foo"));
    /*fooAd3 = */create(new Ad().setCreatedUserId(otherCommunityUser.getId()).setCommunityId(otherCommunityUser.getId()).setPoints(TEN).setTitle("foo"));
    /*barAd =  */create(new Ad().setCreatedUserId(barUser.getId()).setCommunityId(community.getId()).setPoints(TEN).setTitle("bar"));
  ...
  public void adList_pagination() throws Exception {
    ...
    create(new Ad().setTitle("page_ad1").setCreatedUserId(pageUser.getId()).setCommunityId(pageCommunity.getId()).setPoints(TEN));
    create(new Ad().setTitle("page_ad2").setCreatedUserId(pageUser.getId()).setCommunityId(pageCommunity.getId()).setPoints(TEN));
    create(new Ad().setTitle("page_ad3").setCreatedUserId(pageUser.getId()).setCommunityId(pageCommunity.getId()).setPoints(TEN));
    create(new Ad().setTitle("page_ad4").setCreatedUserId(pageUser.getId()).setCommunityId(pageCommunity.getId()).setPoints(TEN));
    create(new Ad().setTitle("page_ad5").setCreatedUserId(pageUser.getId()).setCommunityId(pageCommunity.getId()).setPoints(TEN));
    create(new Ad().setTitle("page_ad6").setCreatedUserId(pageUser.getId()).setCommunityId(pageCommunity.getId()).setPoints(TEN));
    create(new Ad().setTitle("page_ad7").setCreatedUserId(pageUser.getId()).setCommunityId(pageCommunity.getId()).setPoints(TEN));
    create(new Ad().setTitle("page_ad8").setCreatedUserId(pageUser.getId()).setCommunityId(pageCommunity.getId()).setPoints(TEN));
    create(new Ad().setTitle("page_ad9").setCreatedUserId(pageUser.getId()).setCommunityId(pageCommunity.getId()).setPoints(TEN));
    create(new Ad().setTitle("page_ad10").setCreatedUserId(pageUser.getId()).setCommunityId(pageCommunity.getId()).setPoints(TEN));
    create(new Ad().setTitle("page_ad11").setCreatedUserId(pageUser.getId()).setCommunityId(pageCommunity.getId()).setPoints(TEN));
    create(new Ad().setTitle("page_ad12").setCreatedUserId(pageUser.getId()).setCommunityId(pageCommunity.getId()).setPoints(TEN));
