...
public class UpdateAdTest extends IntegrationTest {
  ...
  public void setupData() throws Exception {
    ...
    ad =  create(new Ad().setPublishStatus(PUBLIC).setCreatedUserId(user.getId()).setCommunityId(community.getId()));
  ...
  public void adUpdate() {
    ...
    given()
      ...
      .when().post("/app/v{v}/ads/{id}", APP_API_VERSION.getMajor(), ad.getId())
      .then().statusCode(200)
