...
public class SearchUserCommutityTest extends IntegrationTest {
  ...
  public void createUser() throws Exception {
    ...
    community4 = create(new Community().setPublishStatus(PUBLIC).setName("comm_bar_foo").setTokenContractAddress("0x0"));
  ...
  public void searchCommutity_nonFilter_pagination() throws Exception {
    // prepare
    Community pageCommunity1 =  create(new Community().setPublishStatus(PUBLIC).setName("page_community1").setTokenContractAddress("0x0"));
    Community pageCommunity2 =  create(new Community().setPublishStatus(PUBLIC).setName("page_community2").setTokenContractAddress("0x0"));
    Community pageCommunity3 =  create(new Community().setPublishStatus(PUBLIC).setName("page_community3").setTokenContractAddress("0x0"));
    Community pageCommunity4 =  create(new Community().setPublishStatus(PUBLIC).setName("page_community4").setTokenContractAddress("0x0"));
    Community pageCommunity5 =  create(new Community().setPublishStatus(PUBLIC).setName("page_community5").setTokenContractAddress("0x0"));
    Community pageCommunity6 =  create(new Community().setPublishStatus(PUBLIC).setName("page_community6").setTokenContractAddress("0x0"));
    Community pageCommunity7 =  create(new Community().setPublishStatus(PUBLIC).setName("page_community7").setTokenContractAddress("0x0"));
    Community pageCommunity8 =  create(new Community().setPublishStatus(PUBLIC).setName("page_community8").setTokenContractAddress("0x0"));
    Community pageCommunity9 =  create(new Community().setPublishStatus(PUBLIC).setName("page_community9").setTokenContractAddress("0x0"));
    Community pageCommunity10 =  create(new Community().setPublishStatus(PUBLIC).setName("page_community10").setTokenContractAddress("0x0"));
    Community pageCommunity11 =  create(new Community().setPublishStatus(PUBLIC).setName("page_community11").setTokenContractAddress("0x0"));
    Community pageCommunity12 =  create(new Community().setPublishStatus(PUBLIC).setName("page_community12").setTokenContractAddress("0x0"));
    ...
    sessionId = loginApp("page_user", "password");
