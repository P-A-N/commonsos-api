...
public class UpdateLastViewTimeTest extends IntegrationTest {
  ...
  public void createUser() throws Exception {
    community1 = create(new Community().setPublishStatus(PUBLIC).setName("community1").setTokenContractAddress("0x0"));
    community2 = create(new Community().setPublishStatus(PUBLIC).setName("community2").setTokenContractAddress("0x0"));
    otherCommunity = create(new Community().setPublishStatus(PUBLIC).setName("otherCommunity").setTokenContractAddress("0x0"));
