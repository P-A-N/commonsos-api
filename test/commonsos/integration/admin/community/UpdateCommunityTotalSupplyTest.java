...
public class UpdateCommunityTotalSupplyTest extends IntegrationTest {
  ...
  public void updateCommunity_ncl() throws Exception {
    ...
    // update community totalSupply
    Map<String, Object> requestParam = getRequestParam(100F);
    given()
      .cookie("JSESSIONID", sessionId)
      .body(gson.toJson(requestParam))
      .when().post("/admin/communities/{id}/totalSupply", com1.getId())
      .then().statusCode(200);
  }
  ...
  public void updateCommunity_com1Admin() throws Exception {
    ...
    given()
      .cookie("JSESSIONID", sessionId)
      .body(gson.toJson(requestParam))
      .when().post("/admin/communities/{id}/totalSupply", com2.getId())
      .then().statusCode(403);
  }
  ...
  private Map<String, Object> getRequestParam(Float totalSupply) {
    Map<String, Object> requestParam = new HashMap<>();
    requestParam.put("totalSupply", totalSupply);
    return requestParam;
  }
}
