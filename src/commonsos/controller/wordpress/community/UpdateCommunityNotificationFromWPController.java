...
public class UpdateCommunityNotificationFromWPController extends AbstractWordpressController {
  ...
  public CommonView handleWordpress(Request request, Response response) {
    UpdateCommunityNotificationCommand command = gson.fromJson(request.body(), UpdateCommunityNotificationCommand.class);
