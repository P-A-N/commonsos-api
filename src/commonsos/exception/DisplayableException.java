...
public class DisplayableException extends CommonsOSException {
  ...
  public static DisplayableException NOT_ENOUGH_FUNDS = new DisplayableException("error.notEnoughFunds");
  ...
  public static DisplayableException COMMUNITY_IS_NOT_PUBLIC = new DisplayableException("error.communityIsNotPublic");
  public static DisplayableException HAS_PAID = new DisplayableException("error.hasPaid");
  ...
  public static DisplayableException getNotMemberOfCommunity(String param) {
    return new DisplayableException(String.format("error.%sNotMemberOfCommunity", param));
  }
